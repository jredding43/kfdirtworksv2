...
const gravelItems = [
  ...
  { name: "5-8-Minus-Crushed", displayName: "5/8 Minus Crushed", price: 35.0, stockStatus: "in-stock" as const},
  { name: "1-1-4-Minus-Crushed", displayName: "1-1/4 Minus Crushed", price: 35.0, stockStatus: "in-stock" as const},
  { name: "3minus", displayName: "3 Minus", price: 35.0, stockStatus: "in-stock" as const},
  { name: "Pea-gravel-updated", displayName: "Pea Gravel 3/8", price: 40.0, stockStatus: "in-stock" as const},
  { name: "CV-Screened-Rock-1-2-1", displayName: "CV Screened Rock 1/2 - 1", price: 38.0, stockStatus: "in-stock" as const},
  { name: "CV-Drain-Rock-2", displayName: "CV Drain Rock 2", price: 38.0, stockStatus: "in-stock" as const},
