...
const decorativeItems = [
  { name: "Gray-Chip", displayName: "Gray Chip 1/4 - 1/2", price: 45.0, stockStatus: "in-stock" as const},
  { name: "Gray-Chip", displayName: "Gray Chip 3/4 - 1", price: 40.0, stockStatus: "in-stock" as const},
  { name: "Huckleberry-Greenstone-1-1-1-2", displayName: "Huckleberry Greenstone 1 - 1-1/2", price: 60.0, stockStatus: "out-of-stock" as const},
  { name: "Huckleberry-Greenstone-1-2-1", displayName: "Huckleberry Greenstone 1/2 - 1", price: 65.0, stockStatus: "out-of-stock" as const},
  ...
  { name: "Basalt-1-1-2", displayName: "Basalt 1-1/2", price: 70.0, stockStatus: "in-stock" as const},
  ...
  { name: "Lava-Rock", displayName: "Lava Rock", price: 95.0, stockStatus: "in-stock" as const},
